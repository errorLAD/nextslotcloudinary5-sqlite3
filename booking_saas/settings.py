...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,liberal-babita-abhishekmishra-6f0b6358.koyeb.app,
nextslot.in,www.nextslot.in').split(',')
...
# SQLite3 for all environments (local and Railway)
DATABASES = {
    'default': {
